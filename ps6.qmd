...
b. Jam - Heavy Traffic plot from aobve

![Dropdown Menu](Screenshots/jam_heavy_traffic.png){ width=400 }
...
![Dropdown Menu](Screenshots/events_road_closures.png){ width=400 }

d. Another question could be: Where are alerts for road closures due to construction the most common?

![Dropdown Menu](Screenshots/road_closed_construction.png){ width=400 }
